...
namespace Examples.AdvancedConfiguration
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // You can set collection of routing keys or specify the exact exchange that will be listened by given routing keys (or route patterns) by message handlers.
